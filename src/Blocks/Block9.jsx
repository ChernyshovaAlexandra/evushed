...
const Block9 = () => {
    return (
        <section className="py-12 px-12 bg-lavender relative z-40">
            <div className="container mx-auto relative">
                <div className="w-full h-full rounded-3xl mx-auto video overflow-hidden" >
                    <div className="w-full">
                        <img src={Video} alt="" />
                    </div>
                    <div className="absolute p-8 left-8 top-8">
                        <h2 className="font-normal text-3xl text-white">Коронавирус изменил<br /> жизнь многих из нас</h2>
                        <p className="text-white mt-6">Истории пациентов со сниженным иммунитетом</p>
