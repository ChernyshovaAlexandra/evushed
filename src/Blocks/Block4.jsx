...
const Block4 = ({ close, raysSt, raysStL, raysSt2, raysBlock, scrollYProgress }) => {
    ...
    return (
        <animated.section className="bg-lavender grid items-center relative"
            style={{ height: '100vh', opacity: raysBlock.opacity }}>
            <div className="absolute w-full h-full" style={{ zIndex: 10 }}>
                <animated.div style={{ display: raysSt.display }}>
                    <img className="absolute -bottom-2 -right-2 w-4/12" src={docAfter} alt="" />
                </animated.div>
                <animated.div style={{ display: raysStL.display }}>
                    <img className="absolute -bottom-2 -right-2 w-4/12" src={docAfterL} alt="" />
                </animated.div>
                <animated.div style={{ display: raysSt2.display }}>
                    <img className="absolute -bottom-2 -right-2 w-4/12" src={docAfter} alt="" />
                </animated.div>
            </div>
            <animated.div
                className={`w-full h-full relative overflow-hidden `}>
                <animated.img src={Rays} className='w-full h-full absolute top-0 ' alt="" style={{ transform: raysSt.transform, opacity: 1 - raysSt.opacity }} />
                <animated.img src={RaysL} className='w-full h-full  absolute top-0' alt="" style={{ transform: raysStL.transform, opacity: raysStL.opacity }} />
            </animated.div>
            <div className="container absolute flex text-2xl left-12  bottom-0 my-auto h-fit top-12 xl:top-24 ">
                <div className="w-5/12">
                    <animated.h2
                        style={{ color: raysStL.color }}
                        className="text-white header min-[1000px]:text-4xl sm:text-5xl 2xl:text-6xl">спектр защиты<br />от Covid-19 </animated.h2>
                    <div className="mt-16 xl:mt-32">
                        <animated.div className="gap-3 items-center" style={{ display: raysSt.display }}>
                        ...
                        <animated.div className=" gap-3 items-center" style={{ display: raysStL.display }}>
                        ...
                        <animated.div className=" gap-3 items-center" style={{ display: raysSt2.display }}>
                        ...
                        <div className="mt-6">
                            <animated.div style={{ color: raysStL.color }}>
                                <animated.div style={{ display: raysSt.display }} className="flex-col">
                                    <h2 className="font-normal text-xl xl:text-3xl">Меры предосторожности</h2>
                                    <p className="text-lg mt-2 font-normal xl:text-2xl">Соблюдение правил личной гигиены, социальное дистанцирование, использование средств индивидуальной защиты (медицинская маска, респиратор, лицевой щиток и т.д.)  </p>
                                </animated.div>
                                <animated.div style={{ display: raysStL.display }} className="flex-col">
                                    <h2 className="font-normal text-xl xl:text-3xl">Вакцинация</h2>
                                    <p className="text-lg mt-2 font-normal xl:text-2xl">Вакцинация является важной опцией профилактики коронавирусной инфекции<sup>3</sup></p>
                                </animated.div>
                                <animated.div style={{ display: raysSt2.display }} className="flex-col">
                                    <h2 className="font-normal text-xl xl:text-3xl">Пассивная иммунизация</h2>
                                    <p className="text-lg mt-2 font-normal xl:text-2xl">Пассивная иммунизация является дополнительной мерой защиты для пациентов со сниженным иммунным статусом или противопоказаниями к вакцинации</p>
                    ...
                    <motion.div variants={props} initial="initial" whileInView='animated' className="mt-6 xl:mt-12">
                        <button style={{zIndex: '998'}} className="btn text-lg xl:text-2xl relative" onClick={() => close(true)}>Узнать больше</button>
                    </motion.div>
                </div>
            ...
            <Parallax speed={5}
                className="w-6/12 absolute bottom-0 right-4" translateX={[20, -20]} translateY={[0, 0]}>
                <animated.div style={{ display: raysSt.display }}>
                    <img src={doc} alt="" />
                </animated.div>
            </Parallax>
