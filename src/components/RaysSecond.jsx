...
const RaysSecond = () => {
    return (
        <svg viewBox="0 0 1440 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_854_5361)">
                <rect width="1440" height="1000" fill="url(#paint0_linear_854_5361)" />
                <g opacity="0.5" filter="url(#filter0_ddif_854_5361)">
                    <path d="M645 1077H8.28094H-100V-100H437.469L481.83 150.092L512.721 326.375L552.504 553.426L645 1077Z" fill="#051647" />
                    <path d="M645 1079H647.384L646.969 1076.65L554.474 553.081L554.474 553.078L514.691 326.03L483.8 149.747L483.799 149.743L439.438 -100.349L439.145 -102H437.469H-100H-102V-100V1077V1079H-100H8.28094H645Z" stroke="#0C32A5" strokeWidth="4" />
                </g>
                <g opacity="0.2" filter="url(#filter1_ddif_854_5361)">
                    <path d="M645 1077H8.28094H-100V-100H437.469L481.83 150.092L512.721 326.375L552.504 553.426L645 1077Z" fill="#051647" />
                </g>
                <g opacity="0.5" filter="url(#filter2_f_854_5361)">
                    <path d="M352 737.859L-100 584V1100H352V737.859Z" fill="#2EB7F2" />
                </g>
                <g style={{ "mixBlendMode": "color-dodge" }} filter="url(#filter3_f_854_5361)">
                    <path d="M-100 235V478.5L1540 143.287L-100 235Z" fill="#0C32A5" />
                </g>
                <g opacity="0.5" filter="url(#filter4_ddif_854_5361)">
